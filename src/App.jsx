    ...
    <main className="books-page"><div className="scroll-progress" aria-hidden="true" /><div className="custom-cursor" aria-hidden="true" /><div className="custom-cursor-ring" aria-hidden="true" />
      ...
      <section className="book-scroll-story" aria-label="Storytelling cinematic pentru cărțile Aura Dobre">
        <div className="book-story-pin">
          <p className="section-kicker"><span className="eyebrow-text">Scroll story</span></p>
      ...
      <section className="books-section books-reader" data-reveal><div><p className="section-kicker"><span className="eyebrow-text">Pentru cititori</span></p><h2>Pentru cine sunt cărțile mele</h2><p>Dacă iubești poveștile întunecate, personajele complexe, tensiunea psihologică și relațiile care nu pot fi reduse la „boy meets girl”, ești în locul potrivit. Cărțile mele sunt pentru cititorii care vor să simtă ceva intens, nu doar să treacă prin pagini.</p><div className="literary-chips">{["dark romance","thriller psihologic","villain energy","literary dark fiction","obsession stories"].map((chip) => <span key={chip}>{chip}</span>)}</div></div></section>

      <section className="books-section behind-author" data-reveal><div><p className="section-kicker"><span className="eyebrow-text">Behind the author</span></p><h2>În spatele poveștilor</h2><p>Sunt Aura Dobre, autor, designer și om care se uită la lume ca la un set de povești posibile. Scriu dintr-un loc în care estetica, psihologia și vulnerabilitatea se întâlnesc.</p><div className="books-actions"><a className="button primary" href="mailto:auraleodobre@gmail.com?subject=Newsletter%20Aura%20Dobre">Abonează-te la newsletter</a><a className="button ghost" href="/" onClick={(event) => onNavigate(event, "/")}>Vezi și lumea mea digitală</a></div></div></section>
