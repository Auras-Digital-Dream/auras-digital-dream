...
const projects = [
  ...
  { slug: "adi-ecoo-2009-sa", title: "ADI ECOO 2009 S.A. — Identitate, Branding, Campanii & Website", category: ["Branding", "Marketing", "Grafică", "Web", "Documente"], image: "/portfolio/adi-ecoo-2009-sa/71bf13109_IMG-20250618-WA0053.jpg", description: "Identitate completă și ecosistem de comunicare: logo, branding, campanii, materiale editoriale, conținut digital și dezvoltare web." },
...
const services = [
  ...
  { icon: Code, title: "Pachet Website", copy: "Pentru branduri care vor un site elegant, rapid și construit pentru încredere și conversie.", list: ["Website de prezentare sau landing page", "Structură UX și texte de bază", "Formular, WhatsApp și CTA-uri", "Responsive mobil și SEO de bază"] },
  { icon: Megaphone, title: "Pachet Social Media", copy: "Pentru vizibilitate constantă, conținut coerent și o prezență care nu pare făcută la întâmplare.", list: ["Template-uri pentru postări și stories", "Calendar de conținut", "Vizualuri pentru campanii", "Idei de texte și direcție editorială"] },
  { icon: FileText, title: "Pachet Documente Profesionale", copy: "Pentru documente, prezentări și materiale oficiale care trebuie să arate ordonat și profesionist.", list: ["Prezentări și rapoarte", "Lucrări academice și licență", "Broșuri, ghiduri și PDF-uri", "Tehnoredactare și structurare"] },
];
